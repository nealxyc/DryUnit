...
public class ParamDefinition {
    ...
    public static class MethodResolver implements Resolver<Collection<Object>, ParameterResolver>{
	
	private String[] ids ;
	private Method method ;
	public MethodResolver(Method m, String... ids){
	    this.method = m ;
	    this.ids = ids ;
	}
	
	@Override
	public Collection<Object> resolve(ParameterResolver obj) {
	...
	public static ParamDefinition[] getFromMethod(Method method) throws ParamResolveException {
